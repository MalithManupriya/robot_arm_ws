...
inline std::string to_yaml(const DetachLink_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use linkattacher_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const linkattacher_msgs::srv::DetachLink_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  linkattacher_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use linkattacher_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const linkattacher_msgs::srv::DetachLink_Event & msg)
{
  return linkattacher_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<linkattacher_msgs::srv::DetachLink_Event>()
{
  return "linkattacher_msgs::srv::DetachLink_Event";
}

template<>
inline const char * name<linkattacher_msgs::srv::DetachLink_Event>()
{
  return "linkattacher_msgs/srv/DetachLink_Event";
}

template<>
struct has_fixed_size<linkattacher_msgs::srv::DetachLink_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<linkattacher_msgs::srv::DetachLink_Event>
  : std::integral_constant<bool, has_bounded_size<linkattacher_msgs::srv::DetachLink_Request>::value && has_bounded_size<linkattacher_msgs::srv::DetachLink_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<linkattacher_msgs::srv::DetachLink_Event>
  : std::true_type {};
