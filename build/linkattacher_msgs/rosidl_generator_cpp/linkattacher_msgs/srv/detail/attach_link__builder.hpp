...
class Init_AttachLink_Event_response
{
public:
  explicit Init_AttachLink_Event_response(::linkattacher_msgs::srv::AttachLink_Event & msg)
  : msg_(msg)
  {}
  ::linkattacher_msgs::srv::AttachLink_Event response(::linkattacher_msgs::srv::AttachLink_Event::_response_type arg)
  {
...
private:
  ::linkattacher_msgs::srv::AttachLink_Event msg_;
};

class Init_AttachLink_Event_request
{
public:
  explicit Init_AttachLink_Event_request(::linkattacher_msgs::srv::AttachLink_Event & msg)
  : msg_(msg)
  {}
  Init_AttachLink_Event_response request(::linkattacher_msgs::srv::AttachLink_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AttachLink_Event_response(msg_);
  }
...
class Init_AttachLink_Event_info
{
public:
  Init_AttachLink_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AttachLink_Event_request info(::linkattacher_msgs::srv::AttachLink_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AttachLink_Event_request(msg_);
  }
...
template<>
inline
auto build<::linkattacher_msgs::srv::AttachLink_Event>()
{
  return linkattacher_msgs::srv::builder::Init_AttachLink_Event_info();
}
