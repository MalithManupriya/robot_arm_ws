...
enum
{
  linkattacher_msgs__srv__DetachLink_Event__request__MAX_SIZE = 1
};
// response
enum
{
  linkattacher_msgs__srv__DetachLink_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/DetachLink in the package linkattacher_msgs.
typedef struct linkattacher_msgs__srv__DetachLink_Event
{
  service_msgs__msg__ServiceEventInfo info;
  linkattacher_msgs__srv__DetachLink_Request__Sequence request;
  linkattacher_msgs__srv__DetachLink_Response__Sequence response;
} linkattacher_msgs__srv__DetachLink_Event;

// Struct for a sequence of linkattacher_msgs__srv__DetachLink_Event.
typedef struct linkattacher_msgs__srv__DetachLink_Event__Sequence
{
