...
// IWYU pragma: private, include "linkattacher_msgs/srv/attach_link.h"
...
linkattacher_msgs__srv__AttachLink__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
...
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
const rosidl_runtime_c__type_description__TypeSource *
linkattacher_msgs__srv__AttachLink_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
const rosidl_runtime_c__type_description__TypeSource *
linkattacher_msgs__srv__AttachLink_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * )) before or use
 * linkattacher_msgs__srv__AttachLink_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * linkattacher_msgs__srv__AttachLink_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
...
/**
 * It calls
 * linkattacher_msgs__srv__AttachLink_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
const rosidl_runtime_c__type_description__TypeSource *
linkattacher_msgs__srv__AttachLink_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * linkattacher_msgs__srv__AttachLink_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_linkattacher_msgs
...
/**
 * It calls
 * linkattacher_msgs__srv__AttachLink_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
